...
export const generateEpisodeData = async () => {
    ...
    const key = ['read/526e9d01-592f-44c9-9669-8b9d812e731a_TEN2_sample_210224', 'read/0401ed50-7505-4b79-9b41-527e0745a4c6_TEN1_sample_210224', 'read/d3c14d48-c040-455e-b2df-63cf9c6f46c0_TEN0_sample_210224']
    ...
    for (let i = 0; i < 6000; i++) {
        ...
        let keyValue = key[Math.floor(Math.random() * (key.length))]
        ...
        const line = chapter.toString() + ';' + name + ';' + keyValue + ';' + '18' + ';' + episodeId.toString() + ';' + description + ';' + serieId + ';' + thumbnail + ';' + price + ';' + likeInit;
        result = result + line + '\n';
    }
